 ...
 * @constructor
 */
function Context(canvas, engine, options) {
  ...
  defaultTexture: {
    get: function () {
      if (this._defaultTexture === undefined) {
        ...
        this._defaultTexture = new BABYLON.RawTexture(new Uint8Array([255, 255, 255, 255]), 1, 1
          ,BABYLON.Engine.TEXTUREFORMAT_RGBA, scene, true, false);
...
Context.prototype.applyRenderState = function (renderState, passState, clear) {
  var previousRenderState = this._currentRenderState;
  var previousPassState = this._currentPassState;
