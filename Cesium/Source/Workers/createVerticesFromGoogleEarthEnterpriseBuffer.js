...
define(['./when-7be8a9d0', './Check-95b5c836', './Math-1bdfdd19', './Cartesian2-e1152338', './Transforms-48138b95', './RuntimeError-c01fec73', './WebGLConstants-daaa9be0', './ComponentDatatype-2d146d74', './AttributeCompression-e971545c', './IntersectionTests-5a95a776', './Plane-22c766bf', './WebMercatorProjection-735ed899', './createTaskProcessorWorker', './EllipsoidTangentPlane-1a6bc559', './OrientedBoundingBox-a120b860', './TerrainEncoding-902bf00f'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, ComponentDatatype, AttributeCompression, IntersectionTests, Plane, WebMercatorProjection, createTaskProcessorWorker, EllipsoidTangentPlane, OrientedBoundingBox, TerrainEncoding) { 'use strict';
