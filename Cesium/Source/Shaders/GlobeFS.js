...
uniform sampler2D u_dayTextures0;\n\
uniform sampler2D u_dayTextures1;\n\
uniform sampler2D u_dayTextures2;\n\
uniform sampler2D u_dayTextures3;\n\
...
\n\
      ...
      // gl_FragColor = texture2D(u_dayTextures0, v_textureCoordinates.st);\n\
}\n\
\n\
#ifdef GROUND_ATMOSPHERE\n\
vec3 computeGroundAtmosphereColor(vec3 fogColor, vec4 finalColor, vec3 atmosphereLightDirection, float cameraDist)\n\
